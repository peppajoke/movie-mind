...
---
# movie_mind Flask Application

Awesome movie_mind created by 
...
```bash
git clone https://github.com//movie-mind movie_mind
cd movie_mind
make install
```
...
```bash
movie_mind create-db   # run once
movie_mind populate-db  # run once (optional)
movie_mind add-user -u admin -p 1234  # ads a user
movie_mind run
```
